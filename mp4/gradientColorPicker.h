...
class gradientColorPicker : public colorPicker
{
  ...
  private:
    RGBAPixel fadeColor1; 	/* The first color to start the gradient at. */
	RGBAPixel fadeColor2; 	/* The second color to end the gradient with. */
	int radius; 			/* How quickly to transition to fadeColor2. */
	int centerX;			/* X coordinate for the center of the gradient. */
	int centerY;			/* Y coordinate for the center of the gradient. */
};
