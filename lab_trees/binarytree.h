...
class BinaryTree
{
  ...
  private:
	 ...
	 */
	void printPaths(const Node* subRoot, std::vector<const Node*> & v) const;
	
	/**
	 * Private helper function to determine leaf nodes.
	 * @param leaf The node to be checked
	 */
	bool isLeafNode(const Node* leaf) const;
	
	/**
	 * Private helper function to print vectors.
	 * @param v The vector to be printed
	 */
	void printVector(const std::vector<const Node*> v) const;
	/**
	 ...
	 */
	int sumDistances(const Node* subRoot, int dis) const;
