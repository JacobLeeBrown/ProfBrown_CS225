...
void verify_finds(vector<pair<K, V>>& data, BTree<K, V>& b)
{
    for (auto& key_val : data) {
        ...
        /*else{
            // cout << ret << endl;
            cout << "CORRECT! Value correct for key: " << key_val.first << endl;
        }*/
    }
}
...
void small_btree_small_order()
{
    ...
    do_inserts(data, b);
    verify_finds(data, b);
    cout << "Find value for key: -999 = "<< b.find(-999) << endl;
    cout << "BTree is valid? " << b.is_valid(4) << endl;
}
...
void large_btree_small_order()
{
    ...
    do_inserts(data, b);
    verify_finds(data, b);
    cout << "BTree is valid? " << b.is_valid(5) << endl;
    b.clear();
    ...
    do_inserts(data, b);
    verify_finds(data, b);
    cout << "BTree is valid? " << b.is_valid(5) << endl << endl;
}
